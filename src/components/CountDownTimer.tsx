...
const App: React.FC = () => {
  ...
  return (
    <div className='bg-gray-100 dark:bg-inherit min-h-10 min-w-full mt-8 flex flex-col items-center justify-center sm:flex-row sm:justify-between py-24 px-8 m-10'>
